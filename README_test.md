...
1. [Pangenomics data](#1-pangenomics-data)
   1. [Pre-processing](#11-pre-processing)
   2. [Processing](#12-processing)
2. [Frequency distribution, TE counts, PCA, and selection scans](#2-frequency-distribution-te-counts-per-individual-pca-and-selection-scans)
3. [Evolutionary age estimates](#3-evolutionary-age-estimates)
4. [Functional genomics analysis](#4-functional-genomics-analysis)
5. [Genomic windows and statistical analysis](#5-genomic-windows-recombination-rate-and-statistical-analysis)
6. [Appendix I - Tools and scripts](#appendix-i---tools-and-scripts)
